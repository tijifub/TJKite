...
The HTML and students-data.js live at the project root — always edit those, never the copies under `public/`.
...
├── students-data.js
├── sync-public.js             ← copies the files above into public/
